...
// turn on the LED if the distance is between dist_min and dist_max
  ...
  else if(dist_min < dist_raw < middle1 || middle1 < dist_raw < middle2 || middle2 < dist_raw < middle3 || middle3 < dist_raw < dist_max){
      analogWrite(PIN_LED, 250);
  }
  else if(dist_raw == middle1 || dist_raw == middle3){
    analogWrite(PIN_LED, 127.5);
  }
  else if(dist_raw == middle2){
